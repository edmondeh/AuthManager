...
Score.prototype = {
    ...
    regex: {
        ...
        number: /[0-9]+/,
        numberOnly: /^[0-9]+$/,
        punctuation: /[\^Â°!"Â§\$%&\/\(\)=\?\\\.:,;\-_#'\+~\*<>\|\[\]\{\}`Â´]+/, // 34
        punctuationOnly: /^[\^Â°!"Â§\$%&\/\(\)=\?\\\.:,;\-_#'\+~\*<>\|\[\]\{\}`Â´]+$/,
        lower: /[a-z]+/,
        lowerOnly: /^[a-z]+$/,
        upper: /[A-Z]+/,
        upperOnly: /^[A-Z]+$/,
    ...
    keyboards: {
        QWERTZ: new Keyboard({ // 480/105 = 4.571428571
            '^': [null, null, null, '^Â°', '1!', null, null], // 1
            'Â°': [null, null, null, '^Â°', '1!', null, null], // 1
            '1': [null, null, '^Â°', '1!', '2"', null, 'qQ@'], // 3
            '!': [null, null, '^Â°', '1!', '2"', null, 'qQ@'], // 3
            '2': [null, null, '1!', '2"', '3Â§', 'qQ@', 'wW'], // 4
            '"': [null, null, '1!', '2"', '3Â§', 'qQ@', 'wW'], //4
            '3': [null, null, '2"', '3Â§', '4$', 'wW', 'eEâ‚¬'], //4
            'Â§': [null, null, '2"', '3Â§', '4$', 'wW', 'eEâ‚¬'], //4
            '4': [null, null, '3Â§', '4$', '5%', 'eEâ‚¬', 'rR'], //4
            '$': [null, null, '3Â§', '4$', '5%', 'eEâ‚¬', 'rR'], //4
            ...
            ']': [null, null, '8([', '9)]', '0=}', 'iI', 'oO'], // 4
            '0': [null, null, '9)]', '0=}', 'ÃŸ?\\', 'oO', 'pP'], // 4
            '=': [null, null, '9)]', '0=}', 'ÃŸ?\\', 'oO', 'pP'], // 4
            '}': [null, null, '9)]', '0=}', 'ÃŸ?\\', 'oO', 'pP'], // 4
            'ÃŸ': [null, null, '0=}', 'ÃŸ?\\', 'Â´`', 'pP', 'Ã¼Ãœ'], // 4
            '?': [null, null, '0=}', 'ÃŸ?\\', 'Â´`', 'pP', 'Ã¼Ãœ'], // 4
            '\\': [null, null, '0=}', 'ÃŸ?\\', 'Â´`', 'pP', 'Ã¼Ãœ'], // 4
            '`': [null, null, 'ÃŸ?\\', 'Â´`', null, 'Ã¼Ãœ', '+*~'], // 3
            'Â´': [null, null, 'ÃŸ?\\', 'Â´`', null, 'Ã¼Ãœ', '+*~'], // 3
            'q': ['1!', '2"', null, 'qQ@', 'wW', null, 'aA'], // 4
            'Q': ['1!', '2"', null, 'qQ@', 'wW', null, 'aA'], // 4
            '@': ['1!', '2"', null, 'qQ@', 'wW', null, 'aA'], // 4
            'w': ['2"', '3Â§', 'qQ@', 'wW', 'eEâ‚¬', 'aA', 'sS'], // 6
            'W': ['2"', '3Â§', 'qQ@', 'wW', 'eEâ‚¬', 'aA', 'sS'], // 6
            'e': ['3Â§', '4$', 'wW', 'eEâ‚¬', 'rR', 'sS', 'dD'], // 6
            'E': ['3Â§', '4$', 'wW', 'eEâ‚¬', 'rR', 'sS', 'dD'], // 6
            'â‚¬': ['3Â§', '4$', 'wW', 'eEâ‚¬', 'rR', 'sS', 'dD'], // 6
            'r': ['4$', '5%', 'eEâ‚¬', 'rR', 'tT', 'dD', 'fF'], // 6
            'R': ['4$', '5%', 'eEâ‚¬', 'rR', 'tT', 'dD', 'fF'], // 6
            ...
            'O': ['9)]', '0=}', 'iI', 'oO', 'pP', 'kK', 'lL'], // 6
            'p': ['0=}', 'ÃŸ?\\', 'oO', 'pP', 'Ã¼Ãœ', 'lL', 'Ã¶Ã–'], // 6
            'P': ['0=}', 'ÃŸ?\\', 'oO', 'pP', 'Ã¼Ãœ', 'lL', 'Ã¶Ã–'], // 6
            'Ã¼': ['ÃŸ?\\', 'Â´`', 'pP', 'Ã¼Ãœ', '+*~', 'Ã¶Ã–', 'Ã¤Ã„'], // 6
            'Ãœ': ['ÃŸ?\\', 'Â´`', 'pP', 'Ã¼Ãœ', '+*~', 'Ã¶Ã–', 'Ã¤Ã„'], // 6
            '+': ['Â´``', null, 'Ã¼Ãœ', '+*~', null, 'Ã¤Ã„', '\'#'], // 4
            '*': ['Â´``', null, 'Ã¼Ãœ', '+*~', null, 'Ã¤Ã„', '\'#'], // 4
            '~': ['Â´``', null, 'Ã¼Ãœ', '+*~', null, 'Ã¤Ã„', '\'#'], // 4
            'a': ['qQ@', 'wW', null, 'aA', 'sS', '<>|', 'yY'], // 5
            'A': ['qQ@', 'wW', null, 'aA', 'sS', '<>|', 'yY'], // 5
            's': ['wW', 'eEâ‚¬', 'aA', 'sS', 'dD', 'yY', 'xX'], // 6
            'S': ['wW', 'eEâ‚¬', 'aA', 'sS', 'dD', 'yY', 'xX'], // 6
            'd': ['eEâ‚¬', 'rR', 'sS', 'dD', 'fF', 'xX', 'cC'], // 6
            'D': ['eEâ‚¬', 'rR', 'sS', 'dD', 'fF', 'xX', 'cC'], // 6
            ...
            'l': ['oO', 'pP', 'kK', 'lL', 'Ã¶Ã–', ',;', '.:'], // 6
            'L': ['oO', 'pP', 'kK', 'lL', 'Ã¶Ã–', ',;', '.:'], // 6
            'Ã¶': ['pP', 'Ã¼Ãœ', 'lL', 'Ã¶Ã–', 'Ã¤Ã„', '.:', '-_'], // 6
            'Ã–': ['pP', 'Ã¼Ãœ', 'lL', 'Ã¶Ã–', 'Ã¤Ã„', '.:', '-_'], // 6
            'Ã¤': ['Ã¼Ãœ', '+*~', 'Ã¶Ã–', 'Ã¤Ã„', '#\'', '-_', null], // 5
            'Ã„': ['Ã¼Ãœ', '+*~', 'Ã¶Ã–', 'Ã¤Ã„', '#\'', '-_', null], // 5
            '#': ['+*~', null, 'Ã¤Ã„', '#\'', null, null, null], // 2
            '\'': ['+*~', null, 'Ã¤Ã„', '#\'', null, null, null], // 2
            ...
            ';': ['kK', 'lL', 'mM', ',;', '.:', null, null], // 4
            '.': ['lL', 'Ã¶Ã–', ',;', '.:', '-_', null, null], // 4
            ':': ['lL', 'Ã¶Ã–', ',;', '.:', '-_', null, null], // 4
            '-': ['Ã¶Ã–', 'Ã¤', '.:', '-_', null, null, null], // 3
            '_': ['Ã¶Ã–', 'Ã¤', '.:', '-_', null, null, null] // 3
        }, 4.571428571),
        QWERTY: new Keyboard({
